...
public class Giro extends javax.swing.JFrame {
    ...
    int monto_giro;
    String rut = "";
    Coleccion giro; //= new Coleccion();

    public void setGiro(Coleccion giro) {
        this.giro = giro;
    }
     ...
     */
    public Giro(Coleccion test) {
        initComponents();
        this.setGiro(test);
        giro.mostrarTablaGiro(jTable1, rut);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Girar"));
        ...
        jbtn_girar.setText("Girar");
        jbtn_girar.setEnabled(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jbtn_girar, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbtn_girarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_girarActionPerformed
        String tipo_cuenta = "";
        monto_giro = Integer.parseInt(this.jtxt_monto.getText());
        ...
        if (this.jrdb_cta_cte.isSelected() || this.jrdb_cta_ahorro.isSelected()) {
            if (monto_giro < 1) {
                JOptionPane.showMessageDialog(this, "El monto debe ser superior a $0", "Error de ingreso valor", 0);
                this.jtxt_monto.setText("");
                this.jtxt_monto.requestFocus();
            } else if (giro.saldoTotalAhorro(rut) < monto_giro && this.jrdb_cta_ahorro.isSelected()) {
                JOptionPane.showMessageDialog(this, "No cuenta con Saldo suficiente en su Cuenta de Ahorros", "Error", 0);
                this.jtxt_monto.setText("");
                this.jtxt_monto.requestFocus();
            }else if((giro.saldoTotalCtaCte(rut) + giro.SaldoLineaCredito(rut))< monto_giro && this.jrdb_cta_cte.isSelected()){
                JOptionPane.showMessageDialog(this, "No cuenta con Saldo suficiente en su Cuenta Corriente + Linea de Crédito", "Error", 0);
                this.jtxt_monto.setText("");
                this.jtxt_monto.requestFocus();
            } else {

                Banco banco = new Banco(this.jtxt_rut.getText(), tipo_cuenta, 0, monto_giro, 0, 0, 0);
                giro.depositar(banco);
                JOptionPane.showMessageDialog(this, "Giro Realizado", "Mensaje", 1);
                this.jtxt_monto.setText("");
                this.jtxt_rut.setEnabled(false);
                this.jbtn_buscar.setEnabled(false);
                this.jtxt_monto.requestFocus();
                giro.mostrarTablaGiro(this.jTable1, rut);

                if (jrdb_cta_cte.isSelected()) {
                    giro.GirarCtaCte(rut);
                    if (giro.saldoTotalCtaCte(rut) < 0) {
                        this.jtxt_ctacte.setText(0 + "");
                    } else {

                        this.jtxt_ctacte.setText(giro.saldoTotalCtaCte(rut) + "");
                    }

                }

                if (jrdb_cta_ahorro.isSelected()) {
                    giro.GirarCtaAhorro(rut);
//                    if (giro.saldoTotalAhorro(rut)<0) {
//                        
//                    } else {
//                    }
                    this.jtxt_ahorro.setText(giro.saldoTotalAhorro(rut) + "");
                }

                this.jtxt_linea_credito.setText(giro.SaldoLineaCredito(rut) + "");
                this.jtxt_totalctacte.setText(giro.TotalCtaCte(rut) + giro.SaldoLineaCredito(rut) + "");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Debe seleccionar una cuenta para girar", "Error cuenta no seleccionada", 0);
            this.jtxt_monto.requestFocus();
        }
    ...
    private void jbtn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_buscarActionPerformed
        ...
        if (bandera == false) {
            ...
            this.jbtn_girar.setEnabled(true);
            giro.mostrarTablaGiro(this.jTable1, rut);
...
//            rowData[0] = dep.get(i).getRut();
//            rowData[1] = dep.get(i).getMonto_deposito();
//            rowData[2] = dep.get(i).getTipo_cuenta();
//            
